...
const ChatIcon = ({ onclick }) => (
  <div
    className="position-fixed  p-3 rounded-circle text-white custom-bottom-icon-action"
    style={{
      bottom: "13px",
      right: "4px",
      cursor: "pointer",
...
const ScrollToTopIcon = ({ onClick }) => (
  <div
    onClick={onClick}
    className="position-fixed z-index-50 p-3 text-white rounded-circle shadow-lg custom-bottom-icon-action"
    style={{
      bottom: "80px",
      right: "8px",
      cursor: "pointer",
